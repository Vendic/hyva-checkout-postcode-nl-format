...
A small [Hyva checkout](https://www.hyva.io/hyva-checkout.html) extension that adds validates the Dutch postcode to the correct format.

Note: this extension only validates the format. It doesn't do a lookup to see if the postcode actually exists For that, use:
